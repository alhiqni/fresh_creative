    ...
    <div class="container-fluid">
        ...
        <div class="card shadow ">
            <div class="card-header text-center">
                <img src="<?= base_url('assets/img/profile/') . $member['image'] ?>" class="rounded-circle img-thumbnail mx-auto" style="width: 150px;">
            ...
            <div class="card-footer text-muted">
                ...
                <h6 class="card-text float-right text-muted m-2">Bergabung <?= date('d F Y', $member['date_create']) ?></h6>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
